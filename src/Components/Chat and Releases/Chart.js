...
import topchart from "../../data/topchart.json"
...
const Chart = () => {
  ...
  return (
    <section className="h-full ">
      <h5 className="text-white text-2xl mt-12 md:mt-0">Top charts</h5>
        ...
        <div className="flex w-full min-w-fit  md:px-2 md:flex-col min-h-fit">
     {
      topchart.map((chart)=>{
        return   <div
        key={chart.id}
        className="bg-gray-900 rounded-3xl m-2 md:mx-0 lg:h-[85px] p-2 min-h-fit w-[60vw] md:w-full min-w-fit"
        onClick={() => {
          // Navigate("/Tomorrows");
        }}
      >
      ...
      {/*      <div
            className="bg-gray-900 rounded-3xl my-2 md:mx-0 lg:h-[85px] p-2 min-h-fit w-[80%] min-w-fit"
            onClick={() => {
              Navigate("/Tomorrows");
            }}
          >
            <div className="flex justify-evenly flex-col md:flex-row md:gap-4 p-1">
              ...
              <div className="mt-4 md:mt-0 xl:-ml-20 lg:pl-16 md:-pl-8">
                ...
                <p className="text-gray-500 md:text-xs">Sean swadder</p>
                <p className="text-white text-xs mt-8 md:mt-2">2:34:45</p>
              </div>
